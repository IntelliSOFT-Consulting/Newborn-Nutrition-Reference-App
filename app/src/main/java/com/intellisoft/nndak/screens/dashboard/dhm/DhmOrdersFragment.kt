 ...
 * Use the [DhmOrdersFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class DhmOrdersFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.apply {
            actionAddRecipient.setOnClickListener {
                findNavController().navigate(DhmOrdersFragmentDirections.navigateToAddRecipient())
            }
        }
