...
/*
        ...
        binding.apply {
            breadcrumb.page.text =
                Html.fromHtml(" <font color=\"#FFFFFF\">Babies > Baby Panel > Feeding</font>")
    ...
    private fun setupViewPager(viewpager: ViewPager) {
        ...
        adapter.addFragment(ExpressionFragment(), "Assess Positioning")
        adapter.addFragment(ExpressionFragment(), "Assess Breastfeeding")
        adapter.addFragment(ExpressionFragment(), "Record Feeding")
