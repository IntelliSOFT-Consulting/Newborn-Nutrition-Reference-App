...
class PositioningHolder(binding: ExpressionHistoryBinding) :
    ...
    fun bindTo(
        data: PositioningHistory,
        onItemClicked: (PositioningHistory) -> Unit
    ) {
        this.tvhDate.text = data.date
        this.tvhFrequency.text = data.hands
        this.tvhTiming.text = data.mum
